...
@router.get("/dataLancamento/{data_lancamento}", response_model=List[Filmes])
...
@router.get("/diretor/{diretor}", response_model=List[Filmes])
...
@router.get("/genero/{genero}", response_model=List[Filmes])
...
@router.put("/{id_filme}/novoEstoque", response_model=Filmes)
...
@router.put("/{id_filme}/novaDataLancamento", response_model=Filmes)
...
@router.put("/{id_filme}/novoNomeFilme", response_model=Filmes)
